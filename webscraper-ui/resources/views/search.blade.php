...
<body>
    <div class="container">
        ...
        <div class="output-container">
            ...
            <div id="keywordSearchSection" >
                ...
                @else
                    <p>No search results to display. Please enter a keyword to search.</p>
                @endif
            </div>
    ...
    <script>
        ...
        // Optionally, you might want to prevent default if you're handling form submission via JavaScript
        event.preventDefault();

        // Disable the Raw Output and Table buttons
